...
[![v1.0](https://img.shields.io/badge/Prototype-v1.0_Cognitive_Lab-f87171?style=flat-square&labelColor=09080e)](.)

<br/>

**[→ Open Live Prototype (v1.0 Cognitive Research Lab)](https://alimulhaqkhan-prog.github.io/aura-x-omega-2025/index.html)**
...
> API keys (Grok / OpenAI) are PIN-protected and stored in browser localStorage only. Never transmitted externally.
